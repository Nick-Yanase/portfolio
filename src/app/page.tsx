    ...
    <Template>
      <section className="w-full bg-purple/10 flex justify-center pt-32 lg:pt-[96px] p-5 relative">
        <div className="max-w-screen-xl w-full flex flex-col md:flex-row items-center md:gap-4 justify-between lg:py-10 z-20">
          <article className="px-2 w-full md:w-3/5 flex flex-col gap-3 items-center md:items-start">
          ...
          <article className="px-2 w-full md:w-2/5 flex items-center md:items-start md:justify-center lg:justify-end flex-col gap-4">
