...
export default function CarrerCard(props: carrerCardProps){
  ...
  const { data, titulo, organizacao, skills, iconOrg, certificationImage} = props
  return(
    <>
      <div className="w-[540px] bg-zinc-900/80 backdrop-blur-2xl flex gap-5 justify-between p-6 rounded-xl transition-shadow duration-300 ease-in-out hover:shadow-[0_0_2px_1px] hover:shadow-violet-500">
        ...
        <div className="flex-1 flex flex-col gap-1 ">
          ...
          <p className="text-lg text-zinc-400 font-semibold tracking-widest uppercase">{organizacao}</p>
      ...
      </div>
      {
        isCertificationModalOpen && (
          <div onClick={closeModal} className="fixed inset-0 bg-black/70 flex justify-center items-center z-[9999]">
            <span className="size-96 bg-orange-600">
              aaaaaaaaa
            </span>
