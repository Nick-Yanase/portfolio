    ...
    {activeIndex === 0 && (
      ...
      >
        {experiencias.map((experiencia) => (
          <motion.div key={experiencia.id} variants={itemVariants} className="w-full flex gap-20 items-center px-1">
            ...
            <motion.div
              ...
              >
              <Image src="images/icon-triangle.svg" alt="icone de triangulo" width={24} height={24} className="z-10"/>
            </motion.div>
          </motion.div>
        ))}
      </motion.div>
    ...
    {activeIndex === 1 && (
      ...
      >
        {formacoes.map((formacao) => (
          <motion.div key={formacao.id} variants={itemVariants} className="w-full flex gap-20 items-center px-1">
            <CarrerCard {...formacao} />
            <motion.div
              initial={{ x: 100, opacity: 0.5 }}
              whileInView={{ x: 0, opacity: 1 }}
    ...
    {activeIndex === 2 && (
      ...
      >
        {certifications.map((certification) => (
          <motion.div key={certification.id} variants={itemVariants} className="w-full flex gap-20 items-center px-1">
